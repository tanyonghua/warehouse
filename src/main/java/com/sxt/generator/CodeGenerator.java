...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("D:\\IdeaProjects\\warehouse\\src\\main\\java");
        gc.setAuthor("Mr谭");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/warehose?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
