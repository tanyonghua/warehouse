			...
			d = {
				input: function()  {
					...
					var a = function(e) {
						e.onfocus = function(){
							var value = t(e).val();
							t(e).attr('lay-val',value);
						};
						e.onblur = function() {
							var value = t(e).val();
							var oldValue = t(e).attr('lay-val');
							var n = t(e).attr("lay-vali");
							if(n != undefined){
								layui.event.call(this, l, "vali(" + n + ")",{
									elem: e,
									value: value,
									oldValue:oldValue,
									othis: t(e)
					...
					f.each(function(e, l) {
						var value = t(l).val();
						t(l).attr('lay-val',value);
						a.call(this, l);
					});
				},
				textarea: function()  {
					var f = u.find("textarea");
					var a = function(e) {
						e.onfocus = function(){
							var value = t(e).val();
							t(e).attr('lay-val',value);
				...
				select: function() {
					var e, i = "请选择",
						...
						v = function(i, l) {
							//CHANGE 有改动
							t(i.target).parent().hasClass(n) && !l || (t("." + a+"ed").parent().find("select").trigger("onblur"),t("." + a).removeClass(a + "ed " + a + "up"), e && d && e.val(d)), e = null
						},
						y = function(i, u, f) {
							var y, p = t(this),
								m = i.find("." + n),
							...
							if(!u) {
								var C = function() {
									...
									w = function(e) {
										//CHANGE 有改动
										i.removeClass(a + "ed " + a + "up"), k.blur(),p.trigger("onblur"), y = null, e || $(k.val(), function(e) {
								...
								f && k.on("keyup", q).on("blur", function(i) {
									...
									var e = t(this),
										...
										oldValue = p.val(),
										n = p.attr("lay-filter"),
										vali = p.attr("lay-vali");
									return !e.hasClass(c) && (e.hasClass("layui-select-tips") ? k.val("") : (k.val(e.text()), e.addClass(s)), e.siblings().removeClass(s), p.val(a).removeClass("layui-form-danger"), layui.event.call(this, l, "select(" + n + ")", {
										elem: p[0],
										value: a,
										oldValue:oldValue,
										othis: i
									}), layui.event.call(this, l, "vali(" + vali + ")", {
										elem: p[0],
										value: a,
										oldValue:oldValue,
										othis: i
						...
						a = function(e, i) {
							...
							e.on("click", function() {
								var t = a.attr("lay-filter"),
									vali = a.attr("lay-vali"),
									n = (a.attr("lay-text") || "").split("|");
								a[0].disabled || (a[0].checked ? (a[0].checked = !1, e.removeClass(i[1]).find("em").text(n[1])) : (a[0].checked = !0, e.addClass(i[1]).find("em").text(n[0])), layui.event.call(a[0], l, i[2] + "(" + t + ")", {
									elem: a[0],
									value: a[0].value,
									othis: e
								}), layui.event.call(a[0], l, "vali(" + vali + ")", {
									elem: a[0],
									value: a[0].value,
									othis: e
								}))
						...
						n = function(a) {
							...
							a.on("click", function() {
								...
								n[0].disabled || (layui.each(d, function() {
									...
									value: n[0].value,
									othis: a
								}), layui.event.call(n[0], l, "vali(" + vali + ")", {
									elem: n[0],
									value: n[0].value,
									othis: a
								}))
